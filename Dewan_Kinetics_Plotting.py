...
def main():
    ...
    odor_concentration = trials['odorconc'][type_1_trials]
    pid_pump = Dewan_PID_Utils.decode_list(trials['PIDPump'][type_1_trials])
    pid_spacer = trials['PIDSpace'][type_1_trials]
    pid_gain = trials['PIDGain'][type_1_trials]
    odor_vial = trials['odorvial'][type_1_trials]
    carrier_flowrate = trials['Carrier_flowrate'][type_1_trials]
    dilutor_flowrate = trials['Dilutor_flowrate'][type_1_trials]
    odor_name = Dewan_PID_Utils.decode_list(trials['odor'][type_1_trials])
